...
Environment:
  ...
  CURSOR_PLAN2API_SESSION_DB_PATH=~/.cursor-plan2api/sessions.db
  CURSOR_PLAN2API_MAX_HISTORY_TOKENS=80000
  CURSOR_PLAN2API_COMPRESSION_LEVEL=default
  CURSOR_PLAN2API_AUTO_CONTINUE_MAX=3
  CURSOR_PLAN2API_CURSOR_API_KEY=       Dashboard API key (alias: CURSOR_API_KEY)
  HTTP_PROXY=                           Outbound proxy for usage API + vision URLs
  HTTPS_PROXY=
