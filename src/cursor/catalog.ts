...
/**
 * Known Cursor CLI model ids synced from `agent --list-models` (2026-07-18).
 * Fallback when CLI returns a subset; live CLI models always win on conflicts.
 */
export const CURSOR_MODEL_CATALOG: readonly CursorCliModel[] = [
  ...
  { id: "claude-fable-5-thinking-xhigh", name: "Fable 5 1M Extra High Thinking" },
  ...
  { id: "claude-fable-5-low", name: "Fable 5 1M Low" },
  { id: "claude-fable-5-medium", name: "Fable 5 1M Medium" },
  { id: "claude-fable-5-high", name: "Fable 5 1M" },
  { id: "claude-fable-5-xhigh", name: "Fable 5 1M Extra High" },
  { id: "claude-fable-5-max", name: "Fable 5 1M Max" },
  { id: "claude-fable-5-thinking-low", name: "Fable 5 1M Low Thinking" },
  { id: "claude-fable-5-thinking-medium", name: "Fable 5 1M Medium Thinking" },
  { id: "claude-fable-5-thinking-max", name: "Fable 5 1M Max Thinking" },
